...
| `vidrio` / `organico` / 그 외(일반) | 145° |
| 기본 수평 복귀 | 90° |

> 분류 성공 시 **판을 먼저 기울인 뒤 입구를 개방**합니다.
...
python3 servo_test.py 18 90        # 분류 판 → 90°
python3 servo_test.py 19 180 0.8   # 입구 → 180°, 0.8초
```
